			...
			this.getLastData()
				.then((lastData) => {
					if (lastData) {
						...
						if ((guesse === "UP" || priceRise < this.buyLimit || priceRise > this.sellLimit) && lastData.euro > 0)
						...
						if ((guesse === "DOWN" || priceRise > this.sellLimit || priceRise < this.buyLimit) && lastData.coin > 0)
